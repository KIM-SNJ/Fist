# Rain World Wiki (Balanced Scale)
...
* **메뉴 그리드(Menu Grid):** 생명체, 아이템, 음식, 업적 카테고리로 이동할 수 있는 직관적인 카드형 UI 구성
...
* **생명체 분류(Creature Types):** 슬러그 캣, 수비적/중립적/적대적/특별한 생명체 등 카테고리별 특징 정리
